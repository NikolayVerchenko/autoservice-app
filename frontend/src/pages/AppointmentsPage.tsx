      ...
      {isOpen ? (
        <div className="fixed inset-0 z-50 bg-black/40 p-6 flex items-center justify-center">
          <form onSubmit={onCreate} className="w-full max-w-lg rounded bg-white p-5 space-y-3">
            ...
            <input className="w-full rounded border px-3 py-2" placeholder="clientId" value={clientId} onChange={(e) => setClientId(e.target.value)} required />
            <input className="w-full rounded border px-3 py-2" placeholder="carId" value={carId} onChange={(e) => setCarId(e.target.value)} required />
            <label className="block text-sm">
              <div className="mb-1 text-slate-600">startAt</div>
            ...
            <label className="block text-sm">
              <div className="mb-1 text-slate-600">endAt</div>
            ...
            <input className="w-full rounded border px-3 py-2" placeholder="comment" value={comment} onChange={(e) => setComment(e.target.value)} />
